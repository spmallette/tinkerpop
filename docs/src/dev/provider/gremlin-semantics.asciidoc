...
* `-0.0 < 0.0 == +0.0`, i.e. negative zero is a distinct value that is strictly less than positive zero and
therefore not <<Equality,Equal>> to it. This holds for both 32-bit and 64-bit floats.
